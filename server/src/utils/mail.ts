...
const sendEmail = async (options: {
  ...
  try {
    ...
    console.error(
      "Email service failed siliently. Make sure that you have provided your MAILTRAP credetials is in the .env file"
    );
...
const emailVerificationMailgenContent = (
  ...
  return {
    body: {
      ...
      action: {
        instructions:
          "To verify your email please click on the following botton",
        button: {
          color: "#22BC66",
