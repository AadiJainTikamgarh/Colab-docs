...
import { registerValidator, loginValidator, changePasswordValidator, forgotPasswordRequestValidator, resendForgotPasswordMailValidator, } from "../validators/validators";
import { authorization } from "../middlewares/auth.middleware";
import { validate } from "../middlewares/validator.middleware";
import { registerUser, login, refreshAccessToken, changePassword, forgotPasswordRequest, resendEmailVerificationMail, resendForgotPasswordMail, verifyEmail, logout, currentUser, } from "../controllers/auth.controllers";
/*
 registerUser - post
 login - post
 changePassword - post
...
router
    ...
    .post(resendForgotPasswordMailValidator(), validate, resendForgotPasswordMail);
