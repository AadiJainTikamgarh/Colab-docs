...
export const handleImageUpload = async (
  ...
  return await new Promise<string>((resolve, reject) => {
    ...
    request.onload = () => {
      ...
      const response = request.response as { secure_url?: string } | null
    ...
    if (abortSignal) {
      ...
      request.addEventListener("loadend", removeAbortListener, { once: true })
      request.addEventListener("abort", removeAbortListener, { once: true })
    }
